...
public class DatabaseSeeder {
    ...
    CommandLineRunner initDatabase(ProductRepository productRepository) {
        return args -> {
            ...
            // 🔹 Para cada categoria, gerar exatamente 5 produtos
            for (String category : categories) {
                for (int i = 1; i <= 5; i++) {
                    ...
                    BigDecimal price;
                    switch (category) {
                        case "processors" -> price = BigDecimal.valueOf(600 + random.nextInt(2600));
                        case "motherboards" -> price = BigDecimal.valueOf(400 + random.nextInt(1600));
                        case "graphics-cards" -> price = BigDecimal.valueOf(1000 + random.nextInt(4000));
                        case "memory" -> price = BigDecimal.valueOf(150 + random.nextInt(600));
                        case "storage-ssd" -> price = BigDecimal.valueOf(200 + random.nextInt(800));
                        case "storage-hdd" -> price = BigDecimal.valueOf(150 + random.nextInt(350));
                        case "cooling" -> price = BigDecimal.valueOf(100 + random.nextInt(400));
                        case "power-supplies" -> price = BigDecimal.valueOf(250 + random.nextInt(550));
                        case "cases" -> price = BigDecimal.valueOf(200 + random.nextInt(800));
                        case "monitors" -> price = BigDecimal.valueOf(700 + random.nextInt(2300));
                        case "keyboards" -> price = BigDecimal.valueOf(100 + random.nextInt(400));
                        case "mice" -> price = BigDecimal.valueOf(50 + random.nextInt(250));
                        case "headsets" -> price = BigDecimal.valueOf(150 + random.nextInt(350));
                        case "networking" -> price = BigDecimal.valueOf(100 + random.nextInt(400));
                        case "peripherals" -> price = BigDecimal.valueOf(50 + random.nextInt(200));
                        case "cables" -> price = BigDecimal.valueOf(20 + random.nextInt(80));
                    ...
                    // 🔹 Iterando sobre as imagens com diferentes extensões
